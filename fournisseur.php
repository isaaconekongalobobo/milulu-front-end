          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
              <div class="row align-items-center my-3">
                <div class="col">
                  <h2 class="page-title texte">A la recherche d'un service ?</h2>
                </div>
<!--                 <div class="col-auto">
              ...
              <div class="file-container border-top">
                <div class="file-panel mt-4">
                  <h6 class="mb-3 texte">Catégorie des services événementiels</h6>
                  <!-- Liste des catégories des services -->
                  <div class="row my-4">

                    <div class="col-md-3">
                      <div class="back shadow text-center mb-4">
                        <div class="card-body file">
                          <div class="border-0 bg-transparent">
                            <a href="detail_service.php?service=decoration" class="lien"><img src="./assets/services/service2.jpg" alt="..." class="card-img-top img-fluid rounded"></a>
                            <div class="card-body">
                              <h5 class="h6 card-title mb-1"><a href="detail_service.php?service=decoration" class="lien">Décoration</a></h5>
                            </div>
                          </div>
                        </div> <!-- .card-body -->
                       </div> <!-- .card -->
                    ...
                    <div class="col-md-3">
                      <div class="back shadow text-center mb-4">
                        <div class="card-body file">
                          <div class="border-0 bg-transparent">
                            <img src="./assets/services/service3.jpg" alt="..." class="card-img-top img-fluid rounded">
                            <div class="card-body">
                              <h5 class="h6 card-title mb-1">Coiffure</h5>
                            </div>
                          </div>
                        </div> <!-- .card-body -->
                       </div> <!-- .card -->
                    ...
                    <div class="col-md-3">
                      <div class="back shadow text-center mb-4">
                        <div class="card-body file">
                          <div class="border-0 bg-transparent">
                            <img src="./assets/services/service4.jpg" alt="..." class="card-img-top img-fluid rounded">
                            <div class="card-body">
                              <h5 class="h6 card-title mb-1">Maquillage</h5>
                            </div>
                          </div>
                        </div> <!-- .card-body -->
                       </div> <!-- .card -->
                    ...
                    <div class="col-md-3">
                      <div class="back shadow text-center mb-4">
                        <div class="card-body file">
                          <div class="border-0 bg-transparent">
                            <img src="./assets/services/service5.jpg" alt="..." class="card-img-top img-fluid rounded">
                            <div class="card-body">
                              <h5 class="h6 card-title mb-1">Photographie</h5>
                            </div>
                          </div>
                        </div> <!-- .card-body -->
                       </div> <!-- .card -->
                    ...
                    <div class="col-md-3">
                      <div class="back shadow text-center mb-4">
                        <div class="card-body file">
                          <div class="border-0 bg-transparent">
                            <img src="./assets/services/service6.jpg" alt="..." class="card-img-top img-fluid rounded">
                            <div class="card-body">
                              <h5 class="h6 card-title mb-1">Videographie</h5>
                            </div>
                          </div>
                        </div> <!-- .card-body -->
                       </div> <!-- .card -->
                    ...
                    <div class="col-md-3">
                      <div class="back shadow text-center mb-4">
                        <div class="card-body file">
                          <div class="border-0 bg-transparent">
                            <img src="./assets/services/service7.jpeg" alt="..." class="card-img-top img-fluid rounded">
                            <div class="card-body">
                              <h5 class="h6 card-title mb-1">Service traiteur</h5>
                            </div>
                          </div>
                        </div> <!-- .card-body -->
                       </div> <!-- .card -->
                    ...
                    <div class="col-md-3" >
                      <div class="back shadow text-center mb-4" style="font-size: 50px;">
                        <div class="card-body file">
                          <div class="border-0 bg-transparent">
                            <img src="./assets/products/p4.jpg" alt="..." class="card-img-top img-fluid rounded">
                            <div class="card-body">
                              <h5 class="h6 card-title mb-1">Location articles</h5>
                            </div>
                          </div>
                        </div> <!-- .card-body -->
                       </div> <!-- .card -->
                  ...
                  <!-- Fin de la liste des catégories des services -->
                  <hr class="my-4">
                  <div class="row align-items-center mb-4">
                    <div class="col">
                      <strong class="texte">Fournisseurs certifiés</strong>
                    </div>
                  </div>
                          ...
                          <div class="card-body file-list">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="flex-fill ml-4 fname">
                                <strong>Jhon amisi</strong><br />
                                <span class="badge badge-light text-muted">Décorateur</span>
