<?php 
session_start();
if (empty($_SESSION['info_fournisseur1']) and strlen($_SESSION['info_fournisseur1']) < 8) {
  header("location:compte-fournisseur");
  exit();
}
 ?>
<!doctype html>
  ...
  <body class="light ">
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form class="col-lg-6 col-md-8 col-10 mx-auto" method="post" action="traitement-5" enctype="multipart/form-data">
